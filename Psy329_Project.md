...
\#Reliability Note: I tried the way we learned in class (code shown
below) and it didn’t work with my dataset for some reason so I used
different methods.

Variable 1: Self-control, TSCS (9 items, R=4,6,9) Variable 2: Grit, GRIT
(8 items, R=1,3,5)

The cronbach’s alpha for self-control is 0.33 and for grit it is 0.02,
...
For self-control, two factors have Eigenvalues above 1, there are 2
points before the flattened point of the scree plot, and there are 2
actual dots above the simulated scree plot, suggesting there are 2
factors. The range of factor loadings and percentage of variance
explained is -0.207-0.569 and 31.092% for factor 1 and -0.460-0.671 and
15.225% for factor 2. Overall, the measurament validity is unacceptable
to good based on factor 1 and unacceptable to acceptable based on factor
2.

For grit, two factors have Eigenvalues above 1, there are 2 points
before the flattened point of the scree plot, and there are 2 actual
dots above the simulated scree plot, suggesting there are 2 factors. The
range of factor loadings and percentage of variance explained is
-0.143-0.820 and 31.187% for factor 1 and -0.198-0.515 and 18.667% for
factor 2. Overall, the measurament validity is unacceptable to good
based on factor 1 and unacceptable to acceptable based on factor 2.
